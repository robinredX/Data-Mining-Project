...
original_path = getwd() # To set the path to the original (current) path as we'll be storing visualization in subdirectories
# which we'll create as we move with the analysis
# Preparing dataset
...
end-start # It took around 7 minutes to read the full data with no other process running
